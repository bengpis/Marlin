 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 1000, 3000 }
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*60), (4*60), (20*60) }
